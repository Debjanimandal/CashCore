      ...
      <main className={styles.main}>
        ...
        {step === 1 && (
          <Card className={styles.stepCard}>
            ...
            <p className={styles.stepDesc}>Paste the Stellar wallet address (starts with G, 56 characters).</p>
            <Input
        ...
        {step === 2 && (
          <Card className={styles.stepCard}>
            ...
            <p className={styles.stepDesc}>Sending to: <span className={styles.monoText}>{to.slice(0, 12)}...{to.slice(-6)}</span></p>
